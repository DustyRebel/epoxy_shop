...
const Admin = () => {
  ...
  return (
    <Container className="d-flex flex-column">
        ...
        <Button variant="outline-info" className="mt-2 p-2" onClick={() => setBTypeVisible(true)}>
          Добавить тип в конструктор
        </Button>
        <Button variant="outline-info" className="mt-2 p-2" onClick={() => setBVariantVisible(true)}>
          Добавить форму к типу
        </Button>
